...
回答1：我希望除了能在公司所处的行业上有所发展，也希望能在开发岗位上继续深耕，通过学习前端、后台的技术成为一名全栈式开发工程师，还有(或者)在沉淀自己的技术同时也加强自己的管理能力，(接触更多的业务实践)。也希望能在大2年时间内成长到高级前端工程师的定位。
...
想寻求更好的职业发展，更好的机会，能接触到更多项目业务，希望在更大的平台找到自己新的方向、拓展自己的能力面和认知面。
...
当然我也有很多缺点，例如我缺乏管理思维，没有太强的大局观。(例如我试过遇到一个技术问题，这个技术点其实也有符合项目的方案了，但是我尝试用更好的方法去解决，导致在上面花费的时间过多，导致进度缓慢需要加班的情况)。
