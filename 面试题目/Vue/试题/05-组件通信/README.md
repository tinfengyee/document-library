...
父组件获取子组件的属性或者调用子组件方法 [expose](https://cn.vuejs.org/api/options-state.html#expose)
...
Vue3 中没有了 EventBus 跨组件通信，但是现在有了一个替代的方案 mitt.js，原理还是 EventBus。mitt基于事件总线的订阅发布模式，任意组件之间都可以通信。
...
![微信图片_20210824003500.jpg](./README.assets/a2f14ac26fad4d2b8fdba288865c2916tplv-k3u1fbpfcp-zoom-in-crop-mark4536000.webp)
...
- [x] [Vue3的8种和Vue2的12种组件通信，值得收藏](https://juejin.cn/post/6999687348120190983)